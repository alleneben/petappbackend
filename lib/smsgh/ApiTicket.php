...
class ApiTicket {
	...
	public function setSupportDepartmentId($value) {
		...
		throwException ( new Smsgh_ApiException ( "Parameter value must be of type 'numeric'" ) );
	}
	...
	public function setSource($value) {
		...
		throwException ( new Smsgh_ApiException ( "Parameter value must be of type 'string'" ) );
	}	

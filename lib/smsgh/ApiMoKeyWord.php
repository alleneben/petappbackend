<?php # $Id: ApiMoKeyWord.php 0 1970-01-01 00:00:00Z mkwayisi $
...
class ApiMoKeyWord {
	...
	public function setAlias1($value) {
		...
		throw new Smsgh_ApiException("Parameter should be of type 'string'");
	}
	...
	public function setNumberPlanId($value) {
		...
		throw new Smsgh_ApiException("Parameter should be of type 'number'");
	}
}

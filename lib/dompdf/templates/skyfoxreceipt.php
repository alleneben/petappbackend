<?php
$grd=$_SESSION['grd'];
$usr=isset($_SESSION['us'])&&$_SESSION['us']['rid']>0?$_SESSION['us']['onm'].' '.$_SESSION['us']['snm']:'Guest User';
...
<table class="sa_signature_box" style="border-top: 1px solid black; padding-top: .2em; margin-top: .2em;">
	<tr>    
	  <td>CUSTOMER:</td><td class="written_field" style="padding-left: 2.5in">&nbsp;</td>
	  <td style="padding-left: 1em">CASHIER:</td><td class="written_field" style="padding-left: 2.5in; text-align: right;">X</td>
	</tr>
	<tr>
	  <td colspan="3" style="padding-top: 0em">&nbsp;</td>
	  <td style="text-align: center; padding-top: 0em;"><?php echo $usr ?></td>
	</tr>

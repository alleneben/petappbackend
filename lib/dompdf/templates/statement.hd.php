...
<tr>
<td>Requested By: <strong><?=$ud['onm']?></strong></td>
<td>Role: <strong><?=$ud['gnm']?></strong></td>
</tr>
</table>
...
<tr><td colspan="6"><h2>Statement (Authorized):</h2></td></tr>
...
<!--
<tr>
<td>Account Bal: <strong><?=$sd['CBL']?></strong></td>
<td>Tot. Inclearing: <strong><?=$sd['TIC']?></strong></td>
<td>Total Debit: <strong><?=$sd['TDB']?></strong></td>
<td>Actual Bal: <strong><?=$sd['ABL']?></strong></td>
</tr>
-->
</table>
